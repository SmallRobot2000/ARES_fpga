...
HD_PWD='/home/lovro/ARES/ARES_fpga/ARES_fpga/ARES_fpga.runs/blk_mem_tile_map_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_tile_map.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_tile_map.tcl
