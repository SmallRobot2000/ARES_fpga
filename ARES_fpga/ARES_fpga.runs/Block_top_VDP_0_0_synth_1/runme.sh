...
HD_PWD='/home/lovro/ARES/ARES_fpga/ARES_fpga/ARES_fpga.runs/Block_top_VDP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_top_VDP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_top_VDP_0_0.tcl
