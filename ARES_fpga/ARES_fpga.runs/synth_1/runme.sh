...
HD_PWD='/home/lovro/Documents/ARES_fpga/ARES_fpga/ARES_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_top_wrapper.tcl
