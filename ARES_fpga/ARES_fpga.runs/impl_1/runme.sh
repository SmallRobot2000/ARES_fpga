...
HD_PWD='/home/lovro/Documents/ARES_fpga/ARES_fpga/ARES_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Block_top_wrapper.tcl -notrace
