...
// Date        : Mon Aug  3 14:14:29 2026
// Host        : lovroRadiona running 64-bit Ubuntu 24.04.4 LTS
// Command     : write_verilog -force -mode synth_stub
//               /home/lovro/Documents/ARES_fpga/ARES_fpga/ARES_fpga.gen/sources_1/bd/Block_top/bd/CPU_block_inst_1/ip/CPU_block_inst_1_VexiiRV_wrapper_0_0/CPU_block_inst_1_VexiiRV_wrapper_0_0_stub.v
...
module CPU_block_inst_1_VexiiRV_wrapper_0_0(clk, reset, cpu_rdtime, cpu_int_timer, 
  cpu_int_soft, cpu_int_m_ext, cpi_int_s_ext, cpu_axi_d_awvalid, cpu_axi_d_awready, 
  cpu_axi_d_awaddr, cpu_axi_d_awid, cpu_axi_d_awlen, cpu_axi_d_awsize, cpu_axi_d_awburst, 
  cpu_axi_d_awcache, cpu_axi_d_awprot, cpu_axi_d_wvalid, cpu_axi_d_wready, cpu_axi_d_wdata, 
  cpu_axi_d_wstrb, cpu_axi_d_wlast, cpu_axi_d_bvalid, cpu_axi_d_bready, cpu_axi_d_bid, 
  cpu_axi_d_bresp, cpu_axi_d_arvalid, cpu_axi_d_arready, cpu_axi_d_araddr, cpu_axi_d_arid, 
  cpu_axi_d_arlen, cpu_axi_d_arsize, cpu_axi_d_arburst, cpu_axi_d_arcache, 
  cpu_axi_d_arprot, cpu_axi_d_rvalid, cpu_axi_d_rready, cpu_axi_d_rdata, cpu_axi_d_rid, 
  cpu_axi_d_rresp, cpu_axi_d_rlast, cpu_axi_i_ar_valid, cpu_axi_i_ar_ready, 
  cpu_axi_i_ar_addr, cpu_axi_i_ar_id, cpu_axi_i_ar_len, cpu_axi_i_ar_size, 
  cpu_axi_i_ar_burst, cpu_axi_i_ar_cache, cpu_axi_i_ar_prot, cpu_axi_i_r_valid, 
  cpu_axi_i_r_ready, cpu_axi_i_r_data, cpu_axi_i_r_id, cpu_axi_i_r_resp, cpu_axi_i_r_last, 
