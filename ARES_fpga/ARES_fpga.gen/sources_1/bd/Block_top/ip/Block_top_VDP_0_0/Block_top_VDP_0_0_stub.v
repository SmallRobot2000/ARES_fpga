...
(* CHECK_LICENSE_TYPE = "Block_top_VDP_0_0,VDP,{}" *) (* CORE_GENERATION_INFO = "Block_top_VDP_0_0,VDP,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=VDP,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,VGA_H_ACTIVE=640,VGA_V_ACTIVE=480,VGA_H_SYNC=96,VGA_V_SYNC=2,VGA_H_FRONT_PORCH=16,VGA_V_FRONT_PORCH=11,VGA_H_BACK_PORCH=48,VGA_V_BACK_PORCH=31,VGA_H_TOTAL=800,VGA_V_TOTAL=524,NUM_GEN=2,T0_GEN_NUM=0,S0_GEN_NUM=1}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "VDP,Vivado 2025.2" *) 
module Block_top_VDP_0_0(t0_map_cpu_addr, t0_map_cpu_din, 
  ...
  s0_att_cpu_addr, s0_att_cpu_din, s0_att_cpu_dout, s0_att_cpu_en, s0_att_cpu_wen, 
  s0_att_cpu_clk, s0_data_cpu_addr, s0_data_cpu_din, s0_data_cpu_dout, s0_data_cpu_en, 
  s0_data_cpu_wen, s0_data_cpu_clk, s_axi_aclk, s_axi_aresetn, h_sync, v_sync, vga_r, vga_g, vga_b)
