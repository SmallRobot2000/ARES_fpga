...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot VexiiRV_wrapper xil_defaultlib.VexiiRV_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim VexiiRV_wrapper -key {Behavioral:sim_1:Functional:VexiiRV_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/Block_top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb VexiiRV_wrapper.wdb xsim.dir libdpi.so)
