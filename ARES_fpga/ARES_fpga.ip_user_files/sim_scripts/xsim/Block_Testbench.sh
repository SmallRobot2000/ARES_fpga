...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L xpm -L util_vector_logic_v2_0_5 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L axi_vip_v1_1_22 -L axi_lite_ipif_v3_0_4 -L axi_uart16550_v2_0_39 -L xlconstant_v1_1_10 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot Block_Testbench xil_defaultlib.Block_Testbench xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Block_Testbench -key {Behavioral:sim_1:Functional:Block_Testbench} -tclbatch cmd.tcl -protoinst "protoinst_files/CPU_block.protoinst" -protoinst "protoinst_files/bd_797d.protoinst" -protoinst "protoinst_files/bd_b9bc.protoinst" -protoinst "protoinst_files/Block_top.protoinst" -protoinst "protoinst_files/CPU_block_inst_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/opt/Vivado/2025.2/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xpm util_vector_logic_v2_0_5 proc_sys_reset_v5_0_17 smartconnect_v1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_36 axi_vip_v1_1_22 axi_lite_ipif_v3_0_4 axi_uart16550_v2_0_39 xlconstant_v1_1_10)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Block_Testbench.wdb xsim.dir libdpi.so)
