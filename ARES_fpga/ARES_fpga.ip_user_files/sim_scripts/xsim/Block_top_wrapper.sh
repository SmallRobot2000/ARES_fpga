...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xpm -L util_vector_logic_v2_0_5 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot Block_top_wrapper xil_defaultlib.Block_top_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Block_top_wrapper -key {Behavioral:sim_1:Functional:Block_top_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/Block_top.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm util_vector_logic_v2_0_5)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Block_top_wrapper.wdb xsim.dir libdpi.so)
