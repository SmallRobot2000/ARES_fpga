...
compile()
{
  ...
  "../../../Alchitry AMIX_RISCV.srcs/sources_1/imports/VexiiRiscv/VexiiRiscv.v" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.VexiiRV_wrapper xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.VexiiRV_wrapper -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log VexiiRV_wrapper_sc.so .tmp_log xcelium_lib waves.shm c.obj)
