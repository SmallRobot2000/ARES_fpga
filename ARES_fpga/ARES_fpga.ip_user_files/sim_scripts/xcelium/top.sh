...
#
# Script generated by Vivado on Wed Jul 22 22:51:18 CEST 2026
...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../../opt/Vivado/2025.2/data/rsb/busdef" \
  ...
  "../../../Alchitry AMIX_RISCV.gen/sources_1/ip/mig_7series_0/mig_7series_0/user_design/rtl/ip_top/mig_7series_v4_2_memc_ui_top_std.v" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib. xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib. -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log _sc.so .tmp_log xcelium_lib waves.shm c.obj)
