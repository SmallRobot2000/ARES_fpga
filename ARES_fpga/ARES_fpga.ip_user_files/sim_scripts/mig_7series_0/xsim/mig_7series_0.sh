...
#
# Script generated by Vivado on Thu Aug 13 15:13:01 CEST 2026
...
simulate()
{
  xsim mig_7series_0 -key {Behavioral:sim_1:Functional:mig_7series_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_797d.protoinst" -protoinst "protoinst_files/bd_b9bc.protoinst" -protoinst "protoinst_files/Block_top.protoinst" -log simulate.log
}
