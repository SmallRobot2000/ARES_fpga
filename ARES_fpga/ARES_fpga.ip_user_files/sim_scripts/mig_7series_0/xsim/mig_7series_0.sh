...
#
# Script generated by Vivado on Wed Aug 05 13:30:31 CEST 2026
...
#                mig_7series_0.sh [-rerun]
#                mig_7series_0.sh [-reset_run]
#                mig_7series_0.sh [-clean]
...
export RDI_DATADIR="/opt/Vivado/2025.2/data"
...
# script info
echo -e "mig_7series_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mig_7series_0 xil_defaultlib.mig_7series_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mig_7series_0 -key {Behavioral:sim_1:Functional:mig_7series_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_797d.protoinst" -protoinst "protoinst_files/bd_b9bc.protoinst" -protoinst "protoinst_files/Block_top.protoinst" -protoinst "protoinst_files/CPU_block_inst_1.protoinst" -log simulate.log
}
...
Usage: mig_7series_0.sh [-rerun]\n\
Usage: mig_7series_0.sh [-reset_run]\n\
Usage: mig_7series_0.sh [-clean]\n\
