...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../../../../../../opt/Vivado/2025.2/data/rsb/busdef" +incdir+"/opt/Vivado/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../opt/Vivado/2025.2/data/rsb/busdef" +incdir+"/opt/Vivado/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../opt/Vivado/2025.2/data/rsb/busdef" +incdir+"/opt/Vivado/2025.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/lovro/ARES/ARES_fpga/ARES_fpga/ARES_fpga.cache/compile_simlib/vcs"
  fi
