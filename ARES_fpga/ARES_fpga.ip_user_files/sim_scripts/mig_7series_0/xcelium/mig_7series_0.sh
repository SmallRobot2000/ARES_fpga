...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../../../../../../opt/Vivado/2025.2/data/rsb/busdef" +incdir+"/opt/Vivado/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../opt/Vivado/2025.2/data/rsb/busdef" +incdir+"/opt/Vivado/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../opt/Vivado/2025.2/data/rsb/busdef" +incdir+"/opt/Vivado/2025.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/lovro/ARES/ARES_fpga/ARES_fpga/ARES_fpga.cache/compile_simlib/xcelium"
  fi
