...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../../opt/Vivado/2025.2/data/rsb/busdef" \
...
reset_run()
{
  files_to_remove=(ucli.key _simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc _simv.daidir vcs_lib c.obj)
