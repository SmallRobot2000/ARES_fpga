...
#
# Script generated by Vivado on Fri Jul 24 15:07:47 CEST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : VexiiRV_wrapper.sh
...
#
# Usage        : VexiiRV_wrapper.sh
#                VexiiRV_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                VexiiRV_wrapper.sh [-rerun]
#                VexiiRV_wrapper.sh [-reset_run]
#                VexiiRV_wrapper.sh [-clean]
#                VexiiRV_wrapper.sh [-reset_log]
#                VexiiRV_wrapper.sh [-help]
#
...
#                script (type 'VexiiRV_wrapper.sh -help' for more information).
#
...
# script info
echo -e "VexiiRV_wrapper.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./VexiiRV_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../../../DDR3\\ test/cores/Alchitry\\ AMIX_RISCV/Alchitry\\ AMIX_RISCV.srcs/sources_1/imports/VexiiRiscv/VexiiRiscv.v" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.VexiiRV_wrapper xil_defaultlib.glbl -o VexiiRV_wrapper_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./VexiiRV_wrapper_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key VexiiRV_wrapper_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc VexiiRV_wrapper_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./VexiiRV_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: VexiiRV_wrapper.sh [-help]\n\
Usage: VexiiRV_wrapper.sh [-step]\n\
Usage: VexiiRV_wrapper.sh [-lib_map_path]\n\
Usage: VexiiRV_wrapper.sh [-rerun]\n\
Usage: VexiiRV_wrapper.sh [-reset_run]\n\
Usage: VexiiRV_wrapper.sh [-clean]\n\
Usage: VexiiRV_wrapper.sh [-reset_log]\n\
Usage: VexiiRV_wrapper.sh [-keep_index]\n\
Usage: VexiiRV_wrapper.sh [-noclean_files]\n\n\
